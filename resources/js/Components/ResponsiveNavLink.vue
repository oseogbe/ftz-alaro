...
const classes = computed(() =>
    props.active
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-secondary text-left text-base font-medium text-secondary bg-secondary/5 focus:outline-none focus:text-secondary focus:bg-secondary/10 focus:border-secondary/70 transition duration-150 ease-in-out'
